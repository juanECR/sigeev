...
class vistaModelo
{
    ...
    {
        $palabras_permitidas_n1 = ['inicio', 'usuarios','eventos','emailComunicados','organizadores','participantes','proveedores','resultadosEventos','tareas','empleados','personas','detalleEvento'];
