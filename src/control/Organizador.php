    ...
    if ($objSesion->verificar_sesion_si_activa($id_sesion, $token)) {
        if ($_POST) {
            ...
            if ($documento =="" ||$razon_social == ""||$tipo== "" || $correo == "" || $telefono == "") {
                ...
                $arr_OrganizadorDoc = $objOrganizador->buscarOrganizadorByDocumento($documento);
                ...
                if ($arr_Organizador) { 
                    ...
                    $id_organizador = $objOrganizador->registrarOrganizador($documento,$razon_social,$tipo,$correo,$telefono);
                    if ($id_organizador > 0) {
